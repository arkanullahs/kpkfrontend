...
const STRINGS: Record<string, { en: string; bn: string }> = {
  ...
  // the price table's column heads, same four as the /phone/ page
  col_shop: { en: "Shop", bn: "দোকান" },
  col_variant: { en: "Variant & warranty", bn: "ভ্যারিয়েন্ট ও ওয়ারেন্টি" },
  col_stock: { en: "Stock", bn: "স্টক" },
  col_price: { en: "Listed price", bn: "তালিকাভুক্ত দাম" },
  offers_foot: { en: "A + or − amount is the difference from the cheapest listing in stock. Shop names are shown so you know who is selling: we carry no links and take no commission.", bn: "+ বা − হলো স্টকে থাকা সবচেয়ে কম দামের সন্গে পার্থক্য। দোকানের নাম দেওয়া হয় জানানোর জন্য — কোনো লিংক বা কমিশন নেই।" },
  // the verdict's balance bar: short enough to sit under a count
  v_bal_good: { en: "strengths", bn: "ভালো দিক" },
  v_bal_bad: { en: "trade-offs", bn: "দুর্বল দিক" },
  ...
  yt_title_plain: { en: "What reviewers said", bn: "রিভিউয়াররা যা বলেছেন" },
  yt_review: { en: "review", bn: "রিভিউ" },
  yt_reviews: { en: "reviews", bn: "রিভিউ" },
  yt_views: { en: "views", bn: "ভিউ" },
  yt_best_for: { en: "Best for", bn: "উপযুক্ত" },
  yt_praised: { en: "Praised", bn: "প্রশংসা" },
  yt_criticised: { en: "Criticised", bn: "সমালোচনা" },
  yt_the_reviews: { en: "The reviews", bn: "রিভিউগুলো" },
  yt_choose: { en: "Choose a reviewer", bn: "রিভিউয়ার বেছে নিন" },
  yt_watch: { en: "Watch on YouTube", bn: "ইউটিউবে দেখুন" },
  yt_highlight: { en: "What the reviews highlight", bn: "রিভিউগুলোতে যা উঠে এসেছে" },
  yt_tradeoffs: { en: "Trade-offs", bn: "সীমাবদ্ধতা" },
  yt_all_themes: { en: "All reported themes", bn: "সব বিষয় দেখুন" },
  yt_fewer_themes: { en: "Fewer themes", bn: "কম দেখান" },
  yt_note: { en: "Summaries of published videos. Bhalo Phone did not conduct these tests.", bn: "প্রকাশিত ভিডিওর সারসংক্ষেপ। ভালো ফোন নিজে এই পরীক্ষাগুলো করেনি।" },
  v_eyebrow: { en: "Buying verdict", bn: "কেনার পরামর্শ" },
  v_question: { en: "Is it worth buying?", bn: "কেনা কি ঠিক হবে?" },
  // opinion_llm's aspect keys (praise_flags / complaint_flags) and its
  // best_for vocabulary, as words: the verdict printed them raw
  // ("Performance_gaming", "Daily, camera") until 2026-09-12
  asp_battery: { en: "Battery life", bn: "ব্যাটারি লাইফ" },
  asp_charging: { en: "Charging speed", bn: "চার্জিং স্পিড" },
  asp_camera: { en: "Camera", bn: "ক্যামেরা" },
  asp_display: { en: "Display", bn: "ডিসপ্লে" },
  asp_performance_gaming: { en: "Gaming performance", bn: "গেমিং পারফরম্যান্স" },
  asp_heating: { en: "Heat management", bn: "তাপ নিয়ন্ত্রণ" },
  asp_software: { en: "Software", bn: "সফটওয়্যার" },
  asp_network: { en: "Network signal", bn: "নেটওয়ার্ক সিগন্যাল" },
  asp_build: { en: "Build quality", bn: "বিল্ড কোয়ালিটি" },
  asp_value: { en: "Value for money", bn: "দামের তুলনায় মান" },
  bf_gaming: { en: "gaming", bn: "গেমিং" },
  bf_camera: { en: "photography", bn: "ছবি তোলা" },
  bf_battery: { en: "long battery life", bn: "লম্বা ব্যাটারি লাইফ" },
  bf_daily: { en: "everyday use", bn: "দৈনন্দিন ব্যবহার" },
  bf_students: { en: "students", bn: "শিক্ষার্থী" },
  bf_seniors: { en: "older users", bn: "বয়স্ক ব্যবহারকারী" },
  bf_value: { en: "value seekers", bn: "সাশ্রয়ী ক্রেতা" },
  v_choose: { en: "Choose it if", bn: "বেছে নিন যদি" },
  v_consider: { en: "Consider alternatives if", bn: "অন্য ফোন দেখুন যদি" },
  v_works: { en: "What works well", bn: "যা ভালো কাজ করে" },
  v_tradeoffs: { en: "Reported trade-offs", bn: "জানা সীমাবদ্ধতা" },
